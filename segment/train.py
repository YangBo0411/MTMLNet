...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='G:\yb\yolov9-multiv5\models\detect\yolov9-single-seg.yaml', help='model.yaml path')
    ...
    parser.add_argument('--name', default='IRSTD-NUAA2 det seg lab', help='save to project/name')
